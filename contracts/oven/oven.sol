...
contract Oven {
    ...
    // *tokensclaimable variables are set during state = EXCHANGING
    ...
    function setStateDeposit() public onlyController {
        require(state == States.CLAIM, "WRONG_STATE");
    ...
    function setStateExchanging() public onlyController {
        require(state == States.DEPOSIT, "WRONG_STATE");
        finalTotalValue = totalValue;
        state = States.EXCHANGING;
    }

    function setStateClaim() public onlyController {
        require(state == States.EXCHANGING, "WRONG_STATE");
    ...
    function deposit() public payable {
        ...
        // OR create setStateDepositForce, which will do something cool with the left over tokens.
        require(state == States.DEPOSIT, "WRONG_STATE");
